...
LEVELS = [
    ...
    {
        # 左辺に付いた演算子を上辺へ回して、上から当てられるようにする。
        "levelId": "v3_027",
        "title": "回してから当てる",
        "hint": "当てられる向きを作る",
        "tutorial": True,
        "rows": 4,
        "cols": 2,
        "tiles": [T("a", 0, 0, 3), T("b", 3, 1, 5, {"left": "+"})],
        "walls": [],
    ...
    {
        # ボス: 三つの出口へ、そのまま出す物と組み立ててから出す物を振り分ける。
        "levelId": "v3_035",
        "title": "出口の総仕上げ",
        "hint": "組み立てる物とそのまま出す物を見分ける",
        "size": 5,
        "tiles": [T("a", 4, 0, 8), T("b", 4, 1, 4, {"left": "+"}),
                  T("c", 4, 2, 5, {"left": "×"}),
                  T("d", 4, 3, 2), T("e", 4, 4, 3, {"left": "×"})],
        "walls": [],
        "floors": [],
        "exits": [E(0, 0, "up", 8), E(0, 2, "up", 20), E(0, 4, "up", 6)],
    },
    ...
    {
        # 壁で二本に割る。片方は ↻ で当てられる向きを作らないと始まらない。
        "levelId": "v3_047",
        "title": "総仕上げ7：回転と複数出口",
        "hint": "当てられる面をどう作るか",
        "rows": 4,
        ...
        "walls": [W(0, 2), W(1, 2), W(2, 2), W(3, 2)],
        "floors": [F(3, 0, "rotate", uses=1)],
        "exits": [E(3, 0, "down", 8), E(3, 3, "down", 24)],
    },
    {
    ...
    },
    {
        ...
        "rows": 6,
        "cols": 6,
        "tiles": [T("a", 5, 0, 10), T("b", 5, 2, 4, {"left": "+"}),
                  T("c", 5, 5, 9), T("d", 5, 4, 9, {"up": "×"})],
        "walls": [W(0, 3), W(1, 3), W(2, 3), W(3, 3), W(4, 3), W(5, 3)],
        "floors": [F(5, 1, "swap", uses=1), F(0, 0, "fact", uses=1),
                   F(4, 4, "rotate", uses=1), F(2, 4, "sqrt", uses=1)],
        "exits": [E(0, 0, "up", 720), E(0, 4, "up", 9)],
    },
]
