...
class SoundService {
  ...
  static const Map<GameSoundEvent, String> _sfxAssets = {
    ...
    GameSoundEvent.mergePlus: 'audio/sfx_merge_plus.wav',
    GameSoundEvent.mergeMinus: 'audio/sfx_merge_minus.wav',
    GameSoundEvent.mergeTimes: 'audio/sfx_merge_times.wav',
    GameSoundEvent.mergeDiv: 'audio/sfx_merge_div.wav',
    GameSoundEvent.burn: 'audio/sfx_burn.wav',
  ...
  static const Map<GameSoundEvent, double> _sfxVolume = {
    ...
    GameSoundEvent.mergePlus: 0.7,
    GameSoundEvent.mergeMinus: 0.7,
    GameSoundEvent.mergeTimes: 0.75,
    GameSoundEvent.mergeDiv: 0.7,
    GameSoundEvent.burn: 0.7,
